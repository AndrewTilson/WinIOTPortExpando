...
namespace WinIOTPortExpando.MCPBase
{
    ...
    public class MCP23008 : MCPBase
    {
        ...
        public void init()
        {
            ...
            {
                PORT_EXPANDER_IODIR_REGISTER_ADDRESS = 0x00,
                PORT_EXPANDER_IPOL_REGISTER_ADDRESS = 0x01,
                PORT_EXPANDER_GPINT_REGISTER_ADDRESS = 0x02,
                PORT_EXPANDER_DEFVAL_REGISTER_ADDRESS = 0x03,
                PORT_EXPANDER_INTCON_REGISTER_ADDRESS = 0x04,
                PORT_EXPANDER_GPPU_REGISTER_ADDRESS = 0x06,
                PORT_EXPANDER_INTF_REGISTER_ADDRESS = 0x07,
